<flow name="AutoQueryParser" category="DOC/GUIDE" spid="foam" description="Syntax reference for AQL (AutoQueryParser Query Language): AND/OR/NOT/grouping operators and value types." keywords="aql,query,parser,smartview,knowledge"/>
