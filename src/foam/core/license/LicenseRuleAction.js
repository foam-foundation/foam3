            ...
            if ( license == null ) {
              ...
              if ( currentCount > license.getQuota() ) {
                ...
                if ( license.getBlocking() && !isRemove ) {
                  // Note: removes are never blocked because it is possible to get stuck in the VIOLATED state
                  // if you change a VIOLATED non-blocking License to a blocking one OR change the quota
