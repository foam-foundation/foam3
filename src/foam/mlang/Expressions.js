...
foam.CLASS({
  ...
  requires: [
    ...
    'foam.mlang.expr.ABS as Absolute',
    'foam.mlang.expr.ROUND as Round',
  ...
  methods: [
    ...
    function SET(arg1) { return this.Set.create({ arg1: arg1 }); },
    ...
    function ABS(arg1) { return this.Absolute.create({ num: arg1 }); },
    function ROUND(arg1, opt_decimals) { return this.Round.create({ num: arg1, digits: opt_decimals || 0 }); },
    function ARRAY() { return this.ArraySink.create() },
    function CONCAT(...args) { return this.Concat.create({ exprs: args}); },
