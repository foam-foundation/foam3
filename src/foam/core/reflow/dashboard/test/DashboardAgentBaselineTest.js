...
foam.CLASS({
  ...
  constants: [
    { name: 'EXPECTED_BAR',      value: '{class:"foam.core.reflow.dashboard.DashboardBarSink",sortOrder:2,includeOthers:true,arg2:{class:"foam.mlang.sink.Count"},groupKeys:[],processArrayValuesIndividually:true,colors:["$barChart1","$barChart2"],timeUnit:4,horizontal:true,barThickness:20,xAxisLabel:"X",yAxisLabel:"Y",showGridLines:false,maintainAspectRatio:true,height:400,legendPosition:2,showTooltipSum:true,animate:false,animationDuration:500}' },
    { name: 'EXPECTED_PIE',      value: '{class:"foam.core.reflow.dashboard.DashboardPieSink",sortOrder:2,arg2:{class:"foam.mlang.sink.Count"},groupKeys:[],processArrayValuesIndividually:true,colors:["$a","$b","$c"],showPercentages:true,cutoutPercentage:50,disableLegendClick:true}' },
