<flow name="cheat-sheet" category="DOC/GUIDE" spid="foam" description="A long-form FOAM3 cheat sheet: class definition syntax, property types, methods, listeners, actions, DAOs, reactivity." keywords="cheat sheet,reference,syntax,quick reference,knowledge"/>
