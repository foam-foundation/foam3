<flow name="Updating Objects in DAOs" category="DOC/GUIDE" spid="foam" description="Explains the read-copy-edit-put pattern: frozen objects, clone()/fclone(), and the DAO write stack." keywords="fclone,frozen objects,put,dao,update,knowledge"/>
