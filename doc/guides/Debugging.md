<flow name="Debugging" category="DOC/GUIDE" spid="foam" description="Practical debugging guide for JavaScript (Chrome DevTools) and Java (JDPA remote debugging in VS Code and IntelliJ)." keywords="debugging,devtools,jdpa,breakpoints"/>
