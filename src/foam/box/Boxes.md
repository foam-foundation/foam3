...
<p>There's a few ways to conceptualize boxes.  You can consider a Box as an object oriented "address."  An HTTP URL for example, is a concrete address, but its just a string.  In Box Based Messaging, you would package your http URL up into an HTTPBox as an Object, and the HTTPBox would be responsible for knowing how to deliver a message to the given url.</p>

<p>As a phycial analogy, a box is something you put an Envelope into.  An Envelope has contents (a payload, or "message"), and it has an optional "return address" or "reply box."</p>
